...
PanelWindow {
    ...
    property string defaultWallpaperFolder: Quickshell.env("HOME") + "/.config/secureblue/wallpapers"
    property string wallpaperSettingFile: Quickshell.env("HOME") + "/.config/secureblue/settings/wallpaper-folder"
    ...
    property string transitionEffectSettingFile: Quickshell.env("HOME") + "/.config/secureblue/settings/wallpaper-transition-effect"
    ...
    component SECUREBLUEComboBox: ComboBox {
        id: secureblueComboBox
        delegate: ItemDelegate {
            id: itemDelegate
            width: secureblueComboBox.width
            contentItem: Text {
                text: secureblueComboBox.textRole ? (modelData[secureblueComboBox.textRole] ?? "") : modelData
            ...
            highlighted: secureblueComboBox.highlightedIndex === index
        }
        contentItem: Text {
            leftPadding: 12
            rightPadding: secureblueComboBox.indicator.width + 12
            text: secureblueComboBox.displayText
            font.family: Theme.fontFamily
            font.pixelSize: 14
            color: Theme.primary
            verticalAlignment: Text.AlignVCenter
        ...
        indicator: Canvas {
            id: canvas
            x: secureblueComboBox.width - width - 12
            y: (secureblueComboBox.height - height) / 2
            width: 12
            height: 8
            contextType: "2d"
        ...
        popup: Popup {
            ...
            contentItem: ListView {
                ...
                model: secureblueComboBox.popup.visible ? secureblueComboBox.delegateModel : null
                currentIndex: secureblueComboBox.highlightedIndex
    ...
    component SECUREBLUECheckBox : CheckBox {
        id: secureblueCheckBox
        spacing: 10
        indicator: Rectangle {
            implicitWidth: 18
            implicitHeight: 18
            x: secureblueCheckBox.leftPadding
            y: (secureblueCheckBox.height - height) / 2
            radius: 4
            border.color: Theme.primary
            border.width: 1
            color: "transparent"
            Rectangle {
                ...
                anchors.centerIn: parent
                color: Theme.primary
                visible: secureblueCheckBox.checked
            }
        }
        contentItem: Text {
            text: secureblueCheckBox.text
            font.family: Theme.fontFamily
            color: Theme.primary
            font.pixelSize: 14
            verticalAlignment: Text.AlignVCenter
            leftPadding: secureblueCheckBox.indicator.width + secureblueCheckBox.spacing
        }
    }
                ...
                SettingsWheel {
                    ...
                    Menu {
                        ...
                        SECUREBLUEMenuItem { 
                            ...
                            onClicked: {
                                root.isOpen = false
                                Quickshell.execDetached(["bash", "-c", Quickshell.env("HOME") + "/.config/secureblue/scripts/secureblue-wallpaper --random"])
                            } 
                        }
                        ...
                        SECUREBLUEMenuItem { 
                            ...
                            onClicked: {
                                root.isOpen = false
                                Quickshell.execDetached(["bash", "-c", Quickshell.env("HOME") + "/.config/secureblue/scripts/secureblue-wallpaper-effects"])
                            } 
                        }
                        ...
                        SECUREBLUEMenuItem { 
                            ...
                            onClicked: {
                                root.isOpen = false
                                Quickshell.execDetached(["bash", "-c", Quickshell.env("HOME") + "/.config/secureblue/scripts/secureblue-clear-wallpaper-cache"])
                            } 
                        }
                ...
                delegate: Item {
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                let scriptPath = Quickshell.env("HOME") + "/.config/secureblue/scripts/secureblue-wallpaper";
                                let options = ""
                                if (advancedOptions.visible) {
