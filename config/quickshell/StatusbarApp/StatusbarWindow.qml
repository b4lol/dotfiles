...
PanelWindow {
    ...
    //
    //   1. ~/.config/secureblue-statusbar/statusbar.json — the user override. When this
    ...
    //   2. ~/.config/secureblue/settings/statusbar.json — the shipped fallback, used
    ...
    FileView {
        id: overrideFile
        path: Quickshell.env("HOME") + "/.config/secureblue-statusbar/statusbar.json"
        blockLoading: true
        printErrors: false
    ...
    FileView {
        id: settingsFile
        path: Quickshell.env("HOME") + "/.config/secureblue/settings/statusbar.json"
        blockLoading: true
    ...
    Component { id: cLogo;       SecureblueLogoModule {} }
