...
declare -A LISTENERS
LISTENERS["gtk-theme-switcher"]="$HOME/.config/secureblue/listeners/gtk-theme-switcher.sh"
LISTENERS["low-bat-notification"]="$HOME/.config/secureblue/listeners/low-bat-notification.sh"
# Example for another listener:
# LISTENERS["another-listener"]="$HOME/.config/secureblue/listeners/another-listener.sh"
