...
-- SECUREBLUE Welcome App
hl.window_rule({
    name = "secureblue-welcome-app",
    match = {title = "SECUREBLUE Welcome"},
    float = true,
    center = true,
    pin = true,
    size = "700 600"
...
-- SECUREBLUE Settings App
hl.window_rule({
    name = "secureblue-settings-app",
    match = {title = "SECUREBLUE Dotfiles Settings"},
    float = true,
    center = true,
    pin = true,
    size = "900 600"
