...
-- Applications
hl.bind(mainMod .. " + RETURN", hl.dsp.exec_cmd("~/.config/secureblue/settings/terminal.sh"), { description = "Open the terminal" })
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd("~/.config/secureblue/settings/browser.sh"), { description = "Open the browser" })
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd("~/.config/secureblue/settings/filemanager"), { description = "Open the filemanager" })
hl.bind(mainMod .. " + CTRL + E", hl.dsp.exec_cmd("~/.config/secureblue/settings/emojipicker.sh"), { description = "Open the emoji picker" })
hl.bind(mainMod .. " + CTRL + C", hl.dsp.exec_cmd("~/.config/secureblue/settings/calculator.sh"), { description = "Open the calculator" })
...
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.exec_cmd("~/.config/secureblue/scripts/secureblue-toggle-allfloat"), { description = "Toggle floating for all windows of workspace" })
...
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd("~/.config/secureblue/scripts/secureblue-wallpaper-app --random"), { description = "Change the wallpaper" })
hl.bind(mainMod .. " + CTRL + W", hl.dsp.exec_cmd("~/.config/secureblue/scripts/secureblue-wallpaper-app"), { description = "Open wallpaper selector" })
hl.bind(mainMod .. " + ALT + W", hl.dsp.exec_cmd("~/.config/secureblue/scripts/secureblue-wallpaper-automation"), { description = "Start random wallpaper script" })
...
hl.bind(mainMod .. " + SHIFT + B", hl.dsp.exec_cmd("~/.config/secureblue/scripts/secureblue-reload-statusbar"), { description = "Reload Status Bar" })
hl.bind(mainMod .. " + CTRL + B", hl.dsp.exec_cmd("~/.config/secureblue/scripts/secureblue-toggle-statusbar"), { description = "Toggle Status Bar" })
hl.bind(mainMod .. " + SHIFT + R", hl.dsp.exec_cmd("~/.config/hypr/scripts/loadconfig.sh"), { description = "Reload hyprland config" })
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd("~/.config/secureblue/scripts/secureblue-cliphist"), { description = "Open clipboard manager" })
hl.bind(mainMod .. " + CTRL + T", hl.dsp.exec_cmd("~/.config/waybar/themeswitcher.sh"), { description = "Open waybar theme switcher" })
hl.bind(mainMod .. " + SHIFT + M", hl.dsp.exec_cmd("~/.config/secureblue/scripts/secureblue-toggle-theme"), { description = "Toggle between light and dark mode" })
hl.bind(mainMod .. " + CTRL + S", hl.dsp.exec_cmd("qs ipc call sidebar toggle"), { description = "Open SECUREBLUE Sidebar widget" })
hl.bind(mainMod .. " + CTRL + C", hl.dsp.exec_cmd("qs ipc call calendar toggle"), { description = "Open SECUREBLUE Calendar widget" })
...
hl.bind(mainMod .. " + CTRL + L", hl.dsp.exec_cmd("~/.config/secureblue/scripts/secureblue-power -l"), { description = "Lock Screen" })
hl.bind(mainMod .. " + SHIFT + H", hl.dsp.exec_cmd("~/.config/secureblue/scripts/secureblue-toggle-hyprsunset"), { description = "Toggle Hyprsunset" })
...
hl.bind("CTRL + ALT + T", hl.dsp.exec_cmd("~/.config/secureblue/themes/themes.sh"), { description = "Open Select Window Menu" })
