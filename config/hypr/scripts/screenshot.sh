...
# Load Settings
if [ -f ~/.config/secureblue/settings/screenshot-folder ]; then
    SAVE_DIR=$(cat ~/.config/secureblue/settings/screenshot-folder)
fi
if [ -f ~/.config/secureblue/settings/screenshot-filename ]; then
    SAVE_FILENAME=$(cat ~/.config/secureblue/settings/screenshot-filename)
fi
...
# Screenshot Editor
export GRIMBLAST_EDITOR="$(cat ~/.config/secureblue/settings/screenshot-editor)"
